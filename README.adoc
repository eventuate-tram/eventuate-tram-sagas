...
* Article [Managing data consistency in a microservice architecture using Sagas - Implementing an orchestration-based saga](https://chrisrichardson.net/post/sagas/2019/12/12/developing-sagas-part-4.html)
* Slides and video [MicroCPH - Managing data consistency in a microservice architecture using Sagas
](https://microservices.io/microservices/sagas/2019/07/09/microcph-sagas.html)
