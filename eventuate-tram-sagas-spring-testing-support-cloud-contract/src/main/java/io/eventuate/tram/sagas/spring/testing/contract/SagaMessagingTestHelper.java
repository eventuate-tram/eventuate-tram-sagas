...
public class SagaMessagingTestHelper {
  ...
  public <C extends Command, R> R sendAndReceiveCommand(CommandEndpoint<C> commandEndpoint, C command, Class<R> replyClass, String sagaType) {
    ...
    sagaCommandProducer.sendCommands(sagaType, sagaId, Collections.singletonList(CommandWithDestinationAndType.command(commandEndpoint.getCommandChannel(), (String)null, (Command)command)), replyTo);
